...
from eckity.genetic_encodings.ga.blackjack_individual import BlackjackIndividual


class BlackjackVectorKPointsCrossover(GeneticOperator):
    ...
    def apply(self, individuals):
        ...
        self.points = sorted(choices(range(0, individuals[0].size()), weights=individuals[0].get_rewards(), k=self.k))
